...
desktopenv(){
    ...
    if [[ "$os" == "alpine" ]] && [[ "$de" == "xfce4" ]] ; then
        ...
        for i in gnupg curl nano git xz at-spi2-core xfce4 xfce4-terminal librsvg dialog exo dbus gtk-engines-murrine gtk-engines-pixbuf
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        for i in gnupg curl nano git xz at-spi2-core gnome gnome-shell gnome-terminal gnome-tweaks nautilus gedit librsvg menu inetutils dialog exo gtk2.0 dbus gtk-murrine-engine gtk-pixbuf-engine
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        echo ""
         pd sh $os --user ubuntu --shared-tmp -- /bin/bash -c '
        ...
        wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/Sweet-cursors.tar.xz 
         ...
         sudo tar -xvf Sweet-Wallpapers.tar.xz -C "/usr/share/backgrounds"
         ...
         sudo tar -xvf gnome-config.tar.xz -C "$HOME/" '
    ...
    # Arch, Manjaro, Artix
        ...
        for i in gnupg curl nano git xz at-spi2-core xfce4 xfce4-goodies xfce4-terminal librsvg menu inetutils dialog exo dbus gtk-engine-murrine gtk2-pixbuf-loader
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        echo -e "${yellow}[+] ${green}installing and setting up themes icons wallpapers"
        echo ""
         pd sh $os --user $user --shared-tmp -- /bin/bash -c '
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/candy-icons-master.tar.xz 
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/Sweet-Ambar-Blue-Dark-v40.tar.xz 
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/01-WhiteSur.tar.xz 
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/WhiteSur-Dark.tar.xz 
        ...
        for i in gnupg curl nano git xz at-spi2-core gnome gnome-shell gnome-terminal gnome-tweaks gnome-shell-extensions nautilus gedit librsvg inetutils dialog exo dbus gtk-engine-murrine gtk-engines
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
    ...
    # Debian-based: Debian, Deepin, Ubuntu, OpenKylin, Pardus
        ...
        echo ""
         ...
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/WhiteSur-Dark.tar.xz 
        wget https://raw.githubusercontent.com/Anon-404/My-assets/main/whitesure/Sweet-cursors.tar.xz 
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/distro-x11/wallpaper/SweetWallpaper.tar.xz
         wget https://raw.githubusercontent.com/Anon-404/My-assets/main/archlinux/config.tar.xz

         sudo rm -rf .config
         sudo tar -xvf Sweet-cursors.tar.xz -C "/usr/share/icons"
         sudo tar -xvf SweetWallpaper.tar.xz -C "/usr/share/backgrounds"
         sudo tar -xvf Sweet-Ambar-Blue-Dark-v40.tar.xz -C "/usr/share/themes/"
         sudo tar -xvf candy-icons-master.tar.xz -C "/usr/share/icons"
         sudo tar -xvf WhiteSur-Dark.tar.xz -C "/usr/share/themes"
         sudo tar -xvf 01-WhiteSur.tar.xz -C "/usr/share/icons"
        ...
        for i in gnupg2 curl nano git xz-utils at-spi2-core gnome gnome-shell gnome-terminal gnome-tweaks gnome-shell-extension-ubuntu-dock nautilus nano gedit librsvg2-common menu inetutils-tools dialog exo-utils dbus-x11 gtk2-engines-murrine gtk2-engines-pixbuf apt-transport-https
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
    ...
    # Fedora
        ...
        for i in gnupg2 curl nano git xz at-spi2-core xfce4-desktop xfce4-goodies xfce4-terminal librsvg2 menu inetutils dialog exo dbus-x11 gtk-murrine-engine gtk2-engines
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        for i in gnupg2 curl nano git xz at-spi2-core gnome-shell gnome-terminal gnome-tweaks gnome-shell-extension-dash-to-dock nautilus gedit librsvg2 gtk-murrine-engine gtk2-engines dialog exo dbus-x11 inetutils
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
    ...
    # OpenSUSE
        ...
        for i in gnupg2 curl nano git xz at-spi2-core xfce4 xfce4-panel xfce4-terminal librsvg menu inetutils dialog exo dbus-1-x11 gtk2-engine-murrine gtk2-engine-pixbuf
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        for i in gnupg2 curl nano git xz at-spi2-core gnome-shell gnome-terminal gnome-tweaks gnome-shell-extension-dash-to-dock nautilus gedit librsvg-2 gtk2-engine-murrine gtk2-engines dialog exo dbus-1 inetutils
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
    ...
    # Void
        ...
        for i in gnupg curl nano git xz at-spi2-core xfce4 xfce4-terminal librsvg menu inetutils dialog exo dbus gtk-engine-murrine gtk2-engines
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
        ...
        for i in gnupg curl nano git xz at-spi2-core gnome gnome-shell gnome-terminal gnome-tweaks gnome-shell-extension-dash-to-dock nautilus gedit librsvg gtk-engine-murrine gtk2-engines dialog exo dbus-1 inetutils
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
