...
desktopenv(){
    ...
    if [[ $os -eq "alpine" ]] && [[ $de -eq "xfce4" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "alpine" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "alpine" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "alpine" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    ...
    elif [[ $os -eq "archlinux" ]] || [[ $os -eq "manjaro" ]] || [[ $os -eq "artix" ]] && [[ $de -eq "xfce4" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "archlinux" ]] || [[ $os -eq "manjaro" ]] || [[ $os -eq "artix" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "archlinux" ]] || [[ $os -eq "manjaro" ]] || [[ $os -eq "artix" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "archlinux" ]] || [[ $os -eq "manjaro" ]] || [[ $os -eq "artix" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    
    # debian deepin ubuntu openkylin pardus

    elif [[ $os -eq "deepin" ]] || [[ $os -eq "deepin" ]] || [[ $os -eq "ubuntu" ]] || [[ $os -eq "openkylin" ]] || [[ $os -eq "pardus" ]] && [[ $de -eq "xfce4" ]] ; then
    ...
    elif [[ $os -eq "deepin" ]] || [[ $os -eq "deepin" ]] || [[ $os -eq "ubuntu" ]] || [[ $os -eq "openkylin" ]] || [[ $os -eq "pardus" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "deepin" ]] || [[ $os -eq "deepin" ]] || [[ $os -eq "ubuntu" ]] || [[ $os -eq "openkylin" ]] || [[ $os -eq "pardus" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "deepin" ]] || [[ $os -eq "deepin" ]] || [[ $os -eq "ubuntu" ]] || [[ $os -eq "openkylin" ]] || [[ $os -eq "pardus" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    ...
    elif [[ $os -eq "fedora" ]] && [[ $de -eq "xfce4" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "fedora" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "fedora" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "fedora" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    ...
    elif [[ $os -eq "opensuse" ]] && [[ $de -eq "xfce4" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "opensuse" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "opensuse" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "opensuse" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    ...
    elif [[ $os -eq "void" ]] && [[ $de -eq "xfce4" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "void" ]] && [[ $de -eq "gnome" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
    
    elif [[ $os -eq "void" ]] && [[ $de -eq "fluxbox" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
        
    elif [[ $os -eq "void" ]] && [[ $de -eq "plasma" ]] ; then
        # command
        echo -e "\n${yellow}[+] ${green}installing ${cyan}$de ${green}desktop environment on ${cyan}$os linux ${white}"
