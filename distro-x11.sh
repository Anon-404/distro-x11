...
desktopenv(){
    ...
    # Arch, Manjaro, Artix
        ...
        for i in gnupg curl nano git xz at-spi2-core xfce4 xfce4-goodies xfce4-terminal librsvg menu inetutils dialog exo dbus gtk-engine-murrine gtk2-pixbuf-loader neofetch fish
        do
            echo ""
            echo -e "${yellow}[+] ${green}Installing $i ${white}"
            echo ""
